...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/07/24 21:44:56 by thanh-ng          #+#    #+#             */
/*   Updated: 2026/07/24 21:44:57 by thanh-ng         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (map_x < 0 || map_y < 0 || map_y >= c->config->height || map_x >= c->config->width)
		return (1);
	if (c->config->map[map_y][map_x] == '1' || c->config->map[map_y][map_x] == ' ')
		return (1);
	return (0);
}
